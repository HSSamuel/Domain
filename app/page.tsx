    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-900 relative overflow-hidden selection:bg-indigo-100">
      ...
      <header className="px-4 md:px-8 py-4 flex justify-between items-center max-w-7xl mx-auto w-full relative z-20">
        <div className="flex items-center gap-2 md:gap-3 group cursor-pointer" onClick={() => { window.scrollTo(0,0); }}>
          ...
          <Image 
            ...
            width={40} 
            height={40} 
            className="w-8 h-8 md:w-10 md:h-10 rounded-xl shadow-sm group-hover:scale-105 transition-transform" 
          />
        ...
        <nav className="hidden md:flex items-center gap-6">
          <a href="#methodology" className="text-sm font-bold text-slate-500 hover:text-indigo-600 transition-colors">
            Methodology
          </a>
          <a href="#support" className="text-sm font-bold text-slate-500 hover:text-indigo-600 transition-colors">
            Support
          </a>
          <Link 
            href="/onboarding" 
            className="text-sm font-black text-white hover:text-white bg-slate-900 hover:bg-indigo-600 transition-all px-5 py-2.5 rounded-xl shadow-md hover:shadow-lg hover:-translate-y-0.5 active:scale-95"
          >
        ...
        <button 
          ...
          className="md:hidden p-2 text-slate-600 hover:text-slate-900 focus:outline-none bg-white/80 rounded-xl border border-slate-200 backdrop-blur-md active:scale-95 transition-transform"
        >
          {isMenuOpen ? (
      ...
      <div className={`md:hidden fixed w-full bg-white/95 backdrop-blur-xl shadow-2xl border-b border-slate-200 z-50 transition-all duration-300 ease-out ${isMenuOpen ? 'top-[72px] opacity-100 visible' : 'top-10 opacity-0 invisible pointer-events-none'}`}>
        <div className="flex flex-col px-6 py-6 gap-2">
          <a href="#methodology" onClick={() => setIsMenuOpen(false)} className="text-base font-bold text-slate-600 py-3 border-b border-slate-100">
            Methodology
          </a>
          <a href="#support" onClick={() => setIsMenuOpen(false)} className="text-base font-bold text-slate-600 py-3 border-b border-slate-100">
            Support
          </a>
          <button 
            onClick={() => router.push('/onboarding')}
            className="mt-4 text-center text-sm font-black text-white bg-slate-900 hover:bg-indigo-600 py-4 rounded-xl transition-colors shadow-md"
          >
            Facilitator Portal
          </button>
        </div>
        ...
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 mb-6">
            <button 
              ...
              className="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2.5 px-8 rounded-xl shadow-sm transition-all text-sm active:scale-95"
            >
              Contact IT Support
            </button>
            <button 
              onClick={() => router.push('/onboarding')} 
              className="w-full sm:w-auto bg-white border-2 border-slate-200 hover:border-slate-300 text-slate-700 font-bold py-2.5 px-8 rounded-xl shadow-sm transition-all text-sm active:scale-95"
            >
          ...
          <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="relative flex justify-center items-center p-5 border-b border-slate-100">
              ...
              <button 
                ...
                className="absolute right-4 text-slate-400 hover:text-rose-500 hover:bg-rose-50 transition-colors p-2 rounded-full"
              >
            ...
            <div className="p-6 space-y-4">
              ...
              <a 
                href="https://wa.me/2348084737049" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center gap-4 w-full p-4 rounded-2xl bg-[#25D366]/10 border border-[#25D366]/20 hover:bg-[#25D366]/20 transition-colors group active:scale-[0.98]"
              >
              ...
              <a 
                href="mailto:smkmayomisamuel@gmail.com" 
                className="flex items-center gap-4 w-full p-4 rounded-2xl bg-indigo-50 border border-indigo-100 hover:bg-indigo-100 transition-colors group active:scale-[0.98]"
              >
