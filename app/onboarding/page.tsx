  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-center py-12 px-4 sm:px-6 font-sans relative overflow-hidden selection:bg-indigo-100">
      ...
      <div className="absolute top-0 inset-x-0 h-full overflow-hidden -z-10 pointer-events-none">
        <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-indigo-300/40 rounded-full mix-blend-multiply filter blur-[120px] animate-[pulse_6s_ease-in-out_infinite]"></div>
        <div className="absolute top-40 -left-20 w-[400px] h-[400px] bg-purple-300/40 rounded-full mix-blend-multiply filter blur-[120px] animate-[pulse_8s_ease-in-out_infinite]" style={{ animationDelay: '2s' }}></div>
      </div>

      <div className="max-w-5xl mx-auto w-full relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="text-center mb-16 space-y-6">
          ...
          <p className="text-lg md:text-xl text-slate-500 font-medium max-w-2xl mx-auto leading-relaxed">
            Three simple steps to instantly transform your standard training topics into high-octane, interactive assessments.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col items-center text-center bg-white/80 backdrop-blur-md border border-slate-200 hover:bg-gradient-to-b hover:from-purple-50/60 hover:to-white/80 hover:border-purple-200 p-8 rounded-[2rem] shadow-sm hover:-translate-y-2 transition-all duration-500 hover:shadow-[0_10px_40px_-15px_rgba(168,85,247,0.25)] group">
            ...
            <p className="text-slate-500 leading-relaxed font-medium text-sm">
              Input your topic and let our AI instantly generate learning objectives, full presentation decks, and complex case studies.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center bg-white/80 backdrop-blur-md border border-slate-200 hover:bg-gradient-to-b hover:from-blue-50/60 hover:to-white/80 hover:border-blue-200 p-8 rounded-[2rem] shadow-sm hover:-translate-y-2 transition-all duration-500 hover:shadow-[0_10px_40px_-15px_rgba(59,130,246,0.25)] group">
            ...
            <p className="text-slate-500 leading-relaxed font-medium text-sm">
              Project the live leaderboard. Trainees use their phones to tackle hybrid assessments, including scenario categorization and analytical MCQs.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center bg-white/80 backdrop-blur-md border border-slate-200 hover:bg-gradient-to-b hover:from-emerald-50/60 hover:to-white/80 hover:border-emerald-200 p-8 rounded-[2rem] shadow-sm hover:-translate-y-2 transition-all duration-500 hover:shadow-[0_10px_40px_-15px_rgba(16,185,129,0.25)] group">
            ...
            <p className="text-slate-500 leading-relaxed font-medium text-sm">
              Conclude the session to instantly reveal a detailed post-training analytics report, complete with descriptive ratings for every domain.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center pb-10">
          <button 
            ...
            className="group relative inline-flex items-center justify-center px-10 py-4 font-black text-white transition-all duration-200 bg-slate-900 rounded-2xl hover:bg-slate-800 hover:shadow-xl hover:-translate-y-1 active:scale-95 disabled:bg-slate-500 disabled:hover:translate-y-0"
          >
