            ...
            <div className="flex justify-between items-center mb-3 pl-2">
              <div className="flex items-center gap-2">
                ...
                <div className="flex bg-slate-100 p-1 rounded-md">
                  ...
                  <button type="button" onClick={() => handleObjectiveChange(index, 'questionType', 'SCENARIO_MCQ')} className={`px-2 py-1 text-xs font-bold rounded transition-all ${obj.questionType === 'SCENARIO_MCQ' ? 'bg-amber-500 text-white' : 'text-slate-500'}`}>Case Study</button>
