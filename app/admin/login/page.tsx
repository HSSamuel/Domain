        ...
        <div className="w-full max-w-md bg-white/90 backdrop-blur-md p-6 md:p-8 rounded-3xl shadow-xl border border-slate-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className="w-full bg-slate-900 hover:bg-slate-800 disabled:bg-slate-400 text-white font-bold py-3 rounded-xl transition-all shadow-md active:scale-95 mt-2 text-sm"
            >
